...
const AddMobile = () => {
    const handleAddPhone = (e) => {
        ...
        if(brand && storage && ram && ram && variant ===""){
            return alert("Please fill all items properly");
        }
        console.log(phone);
        ...
        <div>
            ...
            <form onSubmit={handleAddPhone}>
                <div className="mt-16 text-center max-w-md mx-auto px-8 pb-14 bg-gray-600">
                    <h2 className="text-4xl font-bold mt-28 pt-10 text-black">Add Phone</h2>
                    <div className="text-left">
                        <label className="font-semibold mt-9">
                            Pick Mobile Brand Name: <br />
                            <select className="py-3 pl-2 pr-4 w-full" name="brand">
                    ...
                    <div className="text-left mt-3">
                        ...
                        <input className="py-3 pl-2 pr-4 w-full" type="text" name="phoneName" id="" required placeholder="Enter phone name" />
                    </div>
                    <div className="text-left mt-3">
                        <h2 className="font-semibold">Phone details</h2>
                        <input className="py-3 pl-2 pr-4 w-full" type="text" name="details" id="" required placeholder="Enter Details" />
                    </div>
                    ...
                    <div className="text-left mt-3">
                        ...
                        <input className="py-3 pl-2 pr-4 w-full" type="number" name="regularPrice" id="" required placeholder="Enter Regular Price" />
                    </div>

                    <div className="text-left mt-3">
                        <h2 className="font-semibold">Offer Price</h2>
                        <input className="py-3 pl-2 pr-4 w-full" type="number" name="offerPrice" id="" required placeholder="Enter Offer Price" />
                    </div>
                    <div className="text-left mt-3">
                        <h2 className="font-semibold">Enter Chipset</h2>
                        <input className="py-3 pl-2 pr-4 w-full" type="text" name="chipset" id="" required placeholder="Enter Chipset" />
                    </div>
                    <div className="text-left mt-3">
                    ...
                    <div className="text-left">
                        <label className="font-semibold mt-9">
                            Storage: <br />
                            <select className="py-3 pl-2 pr-4 w-full" name="selectedStorage">
                    ...
                    <div className="text-left">
                        <label className="font-semibold mt-9">
                            Ram: <br />
                            <select className="py-3 pl-2 pr-4 w-full" name="selectedRam">
                    ...
                    <div className="text-left">
                        <label className="font-semibold mt-9">
                            Enter Variant: <br />
                            <select className="py-3 pl-2 pr-4 w-full" name="selectedVariant">
                    ...
                    <button className="bg-base-300 py-3 px-5 mt-4 w-full rounded-sm">Add Phones</button>
                </div>
            </form>
            <Footer></Footer>
        </div>
